...
@interface TieziViewController ()<RefreshTableViewDelegate,UITableViewDataSource,UITableViewDelegate>
{
...
-(void)huifuClick
{
    ...
    HuifuViewController *vc = [[HuifuViewController alloc]init];
...
-(void)loadData
{
    ...
    NSString *urlstr = [NSString stringWithFormat:@"%@json.php?t=5&fid=%@&p=%d", SERVER_URL,userID,mpage + 1];
