...
#import "UMSocialQQHandler.h"
@interface BannerDetalViewController ()<UIGestureRecognizerDelegate,UIWebViewDelegate,UIAlertViewDelegate,UIAlertViewDelegate>
{
    UIWebView *mWebView;
    NSString *textUrl;
...
@implementation BannerDetalViewController
...
{
    mpage ++;
    if (mpage ==self.dataArray.count) {
        mpage = self.dataArray.count - 1;
        MBProgressHUD *hud = [MBProgressHUD showHUDAddedTo:self.view animated:YES];
        hud.mode = MBProgressHUDModeText;
        hud.labelText = @"已经到头了";
        hud.margin = 10.f;
...
- (void)LoadArticleDetail {
    ...
    [self StartLoading];
    NSDictionary *dic =self.dataArray[mpage];
    NSString *s = [NSString stringWithFormat:@"%@",dic[@"content"]];
    NSString *urlstr = [NSString stringWithFormat:@"%@json_watch.php?t=29&fid=%@", SERVER_URL, s];
    textUrl = urlstr;
...
- (void)OnLoadFinish:(ImageDownManager *)sender {
    ...
    if (dict && [dict isKindOfClass:[NSDictionary class]]) {
        ...
        if (array && [array isKindOfClass:[NSArray class]] && array.count>0) {
            ...
            if ([[tmpDict objectForKey:@"username"]isEqualToString:@"taidi"]) {
                content = [NSString stringWithFormat:@"<html><head><style type=\"text/css\">img {width: 100%%}</style></head><body><div style=\"font-size:21px;margin-top:10px\"><span style=\"font-weight:bold\">%@</span></div><div style=\"font-size:16px;color:#888888\">%@&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<span style=\"font-size:13px;color:#888888;text-align:right\">%@</span></div><div style=\"margin-top:5px\"><img src=\"file://%@\"/></div><br><div style=\"text-align:justify\"><span style=\"line-height:25px;\">%@</span></div></body></html>", self.dataArray[mpage][@"title"], [tmpDict objectForKey:@"username"], str1,lineimage, content];
            }
            else
            {
               content = [NSString stringWithFormat:@"<html><head><style type=\"text/css\">img {width: 100%%}</style></head><body><div style=\"font-size:21px;margin-top:10px\"><span style=\"font-weight:bold\">%@</span></div><div style=\"font-size:16px;color:#888888\">%@&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<span style=\"font-size:14px;color:#888888;text-align:right\">%@</span></div><div style=\"margin-top:5px\"><img src=\"file://%@\"/></div><br><div style=\"text-align:justify\"><span style=\"line-height:25px;\">%@</span></div></body></html>", self.dataArray[mpage][@"title"], [tmpDict objectForKey:@"username"], str1,lineimage, content];
            }
            NSLog(@"%@", lineimage);
...
{
    [self tapShadow];
    NSString *shareText = [NSString stringWithFormat:@"%@%@",self.dataArray[mpage][@"title"],self.shareUrl];             //分享内嵌文字
    //分享内嵌图片
